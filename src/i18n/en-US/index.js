export default {
  ...
  timezoneMismatchLead:
    'Your device and admin do not use the same timezone.',
  timezoneMismatchDeviceLabel: 'This device',
  timezoneMismatchClinicLabel: 'Admin timezone',
  ...
  tenantDateFormatPlaceholder: 'Select date format',
  tenantTimeFormatPlaceholder: 'Select time format',
  tenantFirstDayPlaceholder: 'Select first day of week',
